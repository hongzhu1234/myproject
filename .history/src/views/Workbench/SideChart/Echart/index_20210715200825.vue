    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class='card-panel' @click="handleSetLineChartData('newVisitis')">
        <div class="card-panel-icon-wrapper icon-people">
          <span class="icon iconfont icon-yonghu_zhanghao_wode" style="font-size: xxx-large;"></span>
        </div>
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('messages')">
        <div class="card-panel-icon-wrapper icon-message">
          <span class="icon iconfont icon-weixin" style="font-size: xxx-large;"></span>
        </div>
        <div class="card-panel-description">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('purchases')">
        <div class="card-panel-icon-wrapper icon-money">
          <span class="icon iconfont icon-B" style="font-size: xxx-large;"></span>
        </div>
        <div class="card-panel-description">
