        ...
        >
          <div v-for="item in data" :key="item.id">
            <el-submenu v-if="item.children" :index="item.index">
              ...
              <el-menu-item v-for="v in item.children" :key="v.id" :index="v.index">
              <template slot="title">
              <i :class="v.icon"></i>
              {{ v.name }}
              </template>
  ...
  data() {
    return {
      ...
      data: [
        {
          name: "主页",
          index: "/work/Workbench",
          icon: "el-icon-s-home",
        },
        {
          name: "接口文档",
          index: "/work/interface",
          icon: "el-icon-set-up",
        },
        {
          name: "代码生成",
